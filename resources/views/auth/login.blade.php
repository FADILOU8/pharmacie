    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .form-group input { width: 100%; padding: 14px 16px; border-radius: 16px; border: 1px solid #cbd5e1; font-size: 1rem; }
            .form-group input:focus { outline: none; border-color: #0ea5e9; box-shadow: 0 0 0 3px rgba(56, 189, 248, 0.12); }
            .btn { width: 100%; padding: 14px 16px; border-radius: 18px; border: none; background: #0ea5e9; color: #ffffff; font-weight: 700; font-size: 1rem; cursor: pointer; }
            .btn:hover { background: #0284c7; }
            .link { margin-top: 18px; text-align: center; font-size: 0.95rem; }
    ...
    <body>
        <div class="auth-page">
            <div class="auth-panel auth-hero">
                <span class="badge">Connexion rapide</span>
                <h1>Bienvenue dans votre gestionnaire de pharmacie moderne</h1>
                <p>Accédez à vos stocks, ventes, ordonnances et rapports en quelques secondes. Une application conçue pour vous faire gagner du temps.</p>
